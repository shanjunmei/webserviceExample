...
public class HelloWorld_ServiceLocator extends org.apache.axis.client.Service implements com.lanhun.cxf.example.client.HelloWorld_Service {
    ...
    private java.lang.String HelloWorldImplPort_address = "http://localhost:8080/helloWorld";
    ...
    public com.lanhun.cxf.example.client.HelloWorld_PortType getHelloWorldImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.lanhun.cxf.example.client.HelloWorldImplPortBindingStub _stub = new com.lanhun.cxf.example.client.HelloWorldImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.lanhun.cxf.example.client.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lanhun.cxf.example.client.HelloWorldImplPortBindingStub _stub = new com.lanhun.cxf.example.client.HelloWorldImplPortBindingStub(new java.net.URL(HelloWorldImplPort_address), this);
                _stub.setPortName(getHelloWorldImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://server.example.cxf.lanhun.com/", "HelloWorld");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://server.example.cxf.lanhun.com/", "HelloWorldImplPort"));
        }
